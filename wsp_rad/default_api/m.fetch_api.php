...
$where_array = array("entered_record_type_name != ?"=>""); // You can change it as per required
...
if(isset($_GET["search"])){
  ...
  $search_operators = array();  //Example $search_operators = array("entered_record_type_name"=>"LIKE","date_created"=>"BETWEEN");
  $nested_where = array();
...
$response_array["entered_record_type"] = $nest1;
