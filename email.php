                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    ...
                                    <h4 class="page-title"><?php echo beautify_meta_name(title_case("email")); ?> <!-- Button trigger modal -->
<button type="button" class="btn btn-success btn-sm" data-toggle="modal" data-target="#add_email"><i class="fe-plus"></i> Add <?php echo beautify_meta_name(title_case("email"));?></button>
</h4>
                                </div>
                            </div>
                        </div>     
...
$columns_to_exclude = array("email_body");
//Action Buttons
$edit_button_url = "edit_email.php?email_id=";
$view_button_url = "view_email.php?email_id=";
$delete_button_class = "delete_email";
//Records
$per_page = 20;
//Offset settings
...
$where_array = array("email_from != ?"=>""); // You can change it as per required
...
<table class="table table-striped" id="list_table_email">
<?php
...
?>
<td class="<?php echo $single_column; ?> <?php echo $single_column."_".create_slug($single_record[$single_column]); ?>"><?php echo pass_thru($single_column,$single_record[$single_column],$record_id,$single_record) ?: $single_record[$single_column];?></td>
  <?php  }
...
//Title,Href,CSS Classes,Icon,Tooltip
$dynamic_buttons = array(
  ["Preview Content","preview_email.php?email_id=$record_id","btn-success","fe-eye"]
);
//Dynamic Buttons Array
...
foreach($dynamic_buttons as $single_button){
  ?>
  <a class="btn btn-sm w-100 mb-1 <?php echo $single_button[2] ?: "btn-info";?>" data-toggle="tooltip" data-placement="top" title="<?php echo $single_button[4] ?: $single_button[0];?>" href="<?php echo $single_button[1]?>"><i class="<?php echo $single_button[3]?>"></i> <?php echo $single_button[0]?></a>
  <?php
}
// loop  buttons endends
?>
<!--Dyanamic buttons -->
...
<!-- Col 1 -->
        ...
        <a href="javascript:void" class="btn btn-secondary btn-sm export_to_csv_email"><i class="fa fa-download" aria-hidden="true"></i> CSV</a>
         <a href="javascript:void" class="btn btn-secondary btn-sm export_to_xls_email"><i class="fa fa-download" aria-hidden="true"></i> Excel</a>
         <a href="javascript:void" class="btn btn-secondary btn-sm print_table_email"><i class="fa fa-print" aria-hidden="true"></i> Print</a>
        </div>
<!-- Col 1 ends -->
</div>
<!-- Row Ends -->
...
<!-- Add email Start-->
<div class="modal fade" id="add_email" tabindex="-1" role="dialog" aria-labelledby="add_email_LongTitle" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle">Add <?php echo beautify_meta_name(title_case("email"));?></h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">×</span>
        </button>
      </div>
      <div class="modal-body">
      <!-- from>i>e,to>i>e,subject>i,status>s>success/failure,body>t,attachments>i --&gt<!-- Form Row Starts -->
        <div class="row">
        <form method="post" action="" id="form_email_rad5ded33b8eb689" class="w-100">
 <div class="form-group ic_email_from col-md-5 d-inline-block">
         <label class="email_from" for="email_from">From</label>
        <input type="email" class="form-control email_from" placeholder="From"  name="email_from">
            </div>
 <div class="form-group ic_email_to col-md-5 d-inline-block">
         <label class="email_to" for="email_to">To</label>
        <input type="email" class="form-control email_to" placeholder="To"  name="email_to">
            </div>
 <div class="form-group ic_email_subject col-md-5 d-inline-block">
         <label class="email_subject" for="email_subject">Subject</label>
        <input type="text" class="form-control email_subject" placeholder="Subject"  name="email_subject">
            </div>
      <div class="form-group ic_email_status col-md-5 d-inline-block">
             <label class="email_status" for="email_status">Status</label>
            <select class="form-control email_status" name="email_status">
    ...
    <div class="form-group ic_email_body col-sm-12">
        ...
        <textarea class="form-control email_body" placeholder="Body" name="email_body"></textarea>
        </div>
 <div class="form-group ic_email_attachments col-md-5 d-inline-block">
        ...
        <input type="text" class="form-control email_attachments" placeholder="Attachments"  name="email_attachments">
            </div>
        
        <div class="form-group col-md-12">
        <input type="submit" class="btn btn-success btn-sm insert_email" value="Add Email" form_id="rad5ded33b8eb689"> 
        </div>
        </form>
        </div>
        <!-- Form Row Ends -->
...
<!-- Quick Edit Modal for email Start-->
<div class="modal fade" id="quick_edit_modal_email" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle">Update <?php echo beautify_meta_name(title_case("email")); ?></h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">×</span>
        </button>
      </div>
      <div class="modal-body ic_age_modal">
      <form method="post" action="" id="form_update_email_quick_edit" class="w-100">
      <input type="hidden" name="record_id" value="" class="quick_edit_email_record_id">
      <div class="modal_input_loader_email">

      </div>
      <div class="form-group col-md-12">
       
        <input type="submit" class="btn btn-success btn-sm update_email" value="Update <?php echo beautify_meta_name(title_case("email")); ?>" form_id="quick_edit"> 
        </div>
        </form>
      </div>
      <div class="modal-footer">
...
<!-- Quick Edit Modal email Ends-->
        ...
        //Insert variables
        var insert_button_class_email = ".insert_email"; // .classname
                var form_id_email = "#form_email";  // #entry_form
                var insert_api_url_email = "api/email/insert_email.php"; // /api/insert.php
                var form_id_parameter_name = "form_id";
                
                //Insert Operation
                $(document).on("click",insert_button_class_email,function(e){
                e.preventDefault();
                var form_to_process_email = form_id_email + "_" + $(this).attr(form_id_parameter_name);
        
                $.post(insert_api_url_email,$(form_to_process_email).serializeArray(),function(data){
              ...
              icon: "error"
                    ...
                    $(form_to_process_email + " input[type=text]").first().focus();
...
customized_content_email.innerHTML = "<a href='edit_email.php?email_id="+entry_id_email+"' class='btn btn-sm btn-warning mt-1'>Edit Email</a> <a href='#' onclick='location.reload()' class='btn btn-sm btn-warning mt-1'>Add New Email</a> <!--<a href='#' class='btn btn-sm btn-success mt-1'>Another Action</a> <a href='#' class='btn btn-sm btn-info mt-1'>Another Action</a> --><br><br><a href='#' onclick='var loc = location.href.replace(location.hash,\"\");window.location = loc;' class='btn btn-sm btn-danger'>Close & Refresh</a> <a href='#' onclick='swal.close()' class='btn btn-sm btn-danger'>X</a>";
swal({
    title: "Success",
...
var records_table_id = "#list_table_email";
$(".export_to_csv_email").click(function(){
$(records_table_id).tableToCSV();
});

$(".export_to_xls_email").click(function(){
...
$(".print_table_email").click(function(){
...
var delete_record_button_class_email = ".delete_email"; // .classname
var primary_record_key_attribute_name_email = "record_id"; //Name of attribute of particular record to edit/update/view/delete.
var delete_api_url_email = "api/email/delete_email.php"; // /api/delete.php

$(document).on("click",delete_record_button_class_email,function(e){
e.preventDefault();
...
.then((willDelete) => {
if (willDelete) {
  var record_id_email = $(this).attr(primary_record_key_attribute_name_email);
    
  $.post(delete_api_url_email,{"record_id":record_id_email});
...
.then((willDelete) => {
  ...
  var api_url = "api/email/delete_email.php"; //Replace with correct API url
...
//Quick Edit Code for email starts
$(".quick_edit_email").click(function(){
          var quick_edit_email_record_type = 'email';
          var quick_edit_email_record_id = $(this).attr("record_id");
          $(".quick_edit_email_record_id").val(quick_edit_email_record_id);
          var quick_edit_email_input_name = $(this).attr("quick_edit_input_name");
          $("#quick_edit_modal_email").modal("show");
          $(".modal_input_loader_email").load("edit_"+quick_edit_email_record_type+".php?"+quick_edit_email_record_type+"_id="+quick_edit_email_record_id+" .ic_"+quick_edit_email_input_name);
        });
        

//Update Variables for email
var qe_update_button_class_email= ".update_email"; // .classname
var qe_form_id_email = "#form_update_email";
var qe_update_api_url_email = "api/email/update_email.php"; // /api/update.php
 var qe_form_id_parameter_name_email = "form_id";
    //Update Operation
    	   $(document).on("click",qe_update_button_class_email,function(e){
e.preventDefault();
    		  var qe_form_to_process_email = qe_form_id_email + "_" + $(this).attr(qe_form_id_parameter_name_email);

    	 $.post(qe_update_api_url_email,$(qe_form_to_process_email).serializeArray(),function(data){
        var qe_response_json_email = data;

if(qe_response_json_email["status"] == "failure"){
  var qe_get_errors_email = qe_response_json_email["errors"];
 
    var errors_returned_email = "";
  $(qe_get_errors_email).each(function(index,value){
            errors_returned_email = errors_returned_email + " => " + value;
    });
    ...
    swal("Error",errors_returned_email, {
      icon: "error"
        ...
        //Reset Form
    		//$(qe_form_to_process_email)[0].reset();

        

    		 // Other functions to execute on success
    		   //Customized buttons
var qe_customized_content_email = document.createElement("div");
qe_customized_content_email.innerHTML = "<a href='javascript:void(0)' onClick='location.reload()' class='btn btn-sm btn-warning mt-1'>Refresh Changes</a> <br><br><a href='javascript:void(0)' onclick='swal.close()' class='btn btn-sm btn-danger'>Close Box</a>";
swal({
    title: "Updated",
    text: "Choose next action",
  content: qe_customized_content_email,
  buttons: false,
  icon : 'success',
});
//Customized buttons
...
//Quick Edit Code for email ends 
        </script>
