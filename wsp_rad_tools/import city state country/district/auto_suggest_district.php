...
foreach($get_suggestions as $single_suggestion){   
    ...
    $this_return_value = $this_return_value . " | ". upper_case($single_suggestion[$single_return]);
}
