                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    ...
                                    <h4 class="page-title"><?php echo beautify_meta_name(title_case("district")); ?> <!-- Button trigger modal -->
<button type="button" class="btn btn-success btn-sm" data-toggle="modal" data-target="#add_district"><i class="fe-plus"></i> Add <?php echo beautify_meta_name(title_case("district"));?></button>
</h4>
                                </div>
                            </div>
                        </div>     
...
//Action Buttons
$edit_button_url = "edit_district.php?district_id=";
$view_button_url = "view_district.php?district_id=";
$delete_button_class = "delete_district";
//Records
$per_page = 20;
//Offset settings
...
$where_array = array("district_name != ?"=>""); // You can change it as per required
...
<table class="table table-striped" id="list_table_district">
<?php
...
<!-- Col 1 -->
        ...
        <a href="javascript:void" class="btn btn-secondary btn-sm export_to_csv_district"><i class="fa fa-download" aria-hidden="true"></i> CSV</a>
         <a href="javascript:void" class="btn btn-secondary btn-sm export_to_xls_district"><i class="fa fa-download" aria-hidden="true"></i> Excel</a>
         <a href="javascript:void" class="btn btn-secondary btn-sm print_table_district"><i class="fa fa-print" aria-hidden="true"></i> Print</a>
        </div>
<!-- Col 1 ends -->
</div>
<!-- Row Ends -->
...
<!-- Add district Start-->
<div class="modal fade" id="add_district" tabindex="-1" role="dialog" aria-labelledby="add_district_LongTitle" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle">Add <?php echo beautify_meta_name(title_case("district"));?></h5>
      ...
      <!-- name>i --&gt<!-- Form Row Starts -->
        <div class="row">
        <form method="post" action="" id="form_district_rad5df86d6284184" class="w-100">
 <div class="form-group ic_district_name col-md-5 d-inline-block">
         <label class="label_district_name" for="district_name">Name</label>
        <input type="text" class="form-control district_name" placeholder="Name"  name="district_name">
            </div>
        
        <div class="form-group col-md-12">
        <input type="submit" class="btn btn-success btn-sm insert_district" value="Add District" form_id="rad5df86d6284184"> 
        </div>
        </form>
        </div>
        <!-- Form Row Ends -->
...
<!-- Quick Edit Modal for district Start-->
<div class="modal fade" id="quick_edit_modal_district" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle">Update <?php echo beautify_meta_name(title_case("district")); ?></h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">×</span>
        </button>
      </div>
      <div class="modal-body ic_age_modal">
      <form method="post" action="" id="form_update_district_quick_edit" class="w-100">
      <input type="hidden" name="record_id" value="" class="quick_edit_district_record_id">
      <div class="modal_input_loader_district">

      </div>
      <div class="form-group col-md-12">
       
        <input type="submit" class="btn btn-success btn-sm update_district" value="Update <?php echo beautify_meta_name(title_case("district")); ?>" form_id="quick_edit"> 
        </div>
        </form>
      </div>
      <div class="modal-footer">
...
<!-- Quick Edit Modal district Ends-->
        ...
        //Insert variables
        var insert_button_class_district = ".insert_district"; // .classname
                var form_id_district = "#form_district";  // #entry_form
                var insert_api_url_district = "api/district/insert_district.php"; // /api/insert.php
                var form_id_parameter_name = "form_id";
                
                //Insert Operation
                $(document).on("click",insert_button_class_district,function(e){                
                e.preventDefault();
                //Processing
                swal("Processing","Please Wait","warning");
                //Processing
                var form_to_process_district = form_id_district + "_" + $(this).attr(form_id_parameter_name);
        
                $.post(insert_api_url_district,$(form_to_process_district).serializeArray(),function(data){
              ...
              icon: "error"
                    ...
                    $(form_to_process_district + " input[type=text]").first().focus();
...
var records_table_id = "#list_table_district";
$(".export_to_csv_district").click(function(){
$(records_table_id).tableToCSV();
});

$(".export_to_xls_district").click(function(){
...
$(".print_table_district").click(function(){
...
var delete_record_button_class_district = ".delete_district"; // .classname
var primary_record_key_attribute_name_district = "record_id"; //Name of attribute of particular record to edit/update/view/delete.
var delete_api_url_district = "api/district/delete_district.php"; // /api/delete.php

$(document).on("click",delete_record_button_class_district,function(e){
e.preventDefault();
...
.then((willDelete) => {
if (willDelete) {
  var record_id_district = $(this).attr(primary_record_key_attribute_name_district);
    
  $.post(delete_api_url_district,{"record_id":record_id_district});
...
.then((willDelete) => {
  ...
  var api_url = "api/district/delete_district.php"; //Replace with correct API url
...
//Quick Edit Code for district starts
$(".quick_edit_district").click(function(){
          var quick_edit_district_record_type = 'district';
          var quick_edit_district_record_id = $(this).attr("record_id");
          $(".quick_edit_district_record_id").val(quick_edit_district_record_id);
          var quick_edit_district_input_name = $(this).attr("quick_edit_input_name");
          $("#quick_edit_modal_district").modal("show");
          $(".modal_input_loader_district").load("edit_"+quick_edit_district_record_type+".php?"+quick_edit_district_record_type+"_id="+quick_edit_district_record_id+" .ic_"+quick_edit_district_input_name);
        });
        

//Update Variables for district
var qe_update_button_class_district= ".update_district"; // .classname
var qe_form_id_district = "#form_update_district";
var qe_update_api_url_district = "api/district/update_district.php"; // /api/update.php
 var qe_form_id_parameter_name_district = "form_id";
    //Update Operation
    	   $(document).on("click",qe_update_button_class_district,function(e){
e.preventDefault();
    		  var qe_form_to_process_district = qe_form_id_district + "_" + $(this).attr(qe_form_id_parameter_name_district);

    	 $.post(qe_update_api_url_district,$(qe_form_to_process_district).serializeArray(),function(data){
        var qe_response_json_district = data;

if(qe_response_json_district["status"] == "failure"){
  var qe_get_errors_district = qe_response_json_district["errors"];
 
    var errors_returned_district = "";
  $(qe_get_errors_district).each(function(index,value){
            errors_returned_district = errors_returned_district + " => " + value;
    });
    ...
    swal("Error",errors_returned_district, {
      icon: "error"
        ...
        //Reset Form
    		//$(qe_form_to_process_district)[0].reset();

        

    		 // Other functions to execute on success
    		   //Customized buttons
var qe_customized_content_district = document.createElement("div");
qe_customized_content_district.innerHTML = "<a href='javascript:void(0)' onClick='location.reload()' class='btn btn-sm btn-warning mt-1'>Refresh Changes</a> <br><br><a href='javascript:void(0)' onclick='swal.close()' class='btn btn-sm btn-danger'>Close Box</a>";
swal({
    title: "Updated",
    text: "Choose next action",
  content: qe_customized_content_district,
  buttons: false,
  icon : 'success',
});
//Customized buttons
...
//Quick Edit Code for district ends 
        </script>
