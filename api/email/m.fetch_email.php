...
$where_array = array("email_name != ?"=>""); // You can change it as per required
...
if(isset($_GET["search"])){
  ...
  $search_operators = array();  //Example $search_operators = array("email_name"=>"LIKE","date_created"=>"BETWEEN");
  $nested_where = array();
