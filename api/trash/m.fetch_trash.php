...
$where_array = array("trash_name != ?"=>""); // You can change it as per required
...
if(isset($_GET["search"])){
  ...
  $search_operators = array();  //Example $search_operators = array("trash_name"=>"LIKE","date_created"=>"BETWEEN");
  $nested_where = array();
