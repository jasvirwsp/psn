...
$where_array = array("branding_name != ?"=>""); // You can change it as per required
...
if(isset($_GET["search"])){
  ...
  $search_operators = array();  //Example $search_operators = array("branding_name"=>"LIKE","date_created"=>"BETWEEN");
  $nested_where = array();
