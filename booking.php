                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    ...
                                    <h4 class="page-title"><?php echo beautify_meta_name(title_case("booking")); ?> <!-- Button trigger modal -->
<button type="button" class="btn btn-success btn-sm" data-toggle="modal" data-target="#add_booking"><i class="fe-plus"></i> Add <?php echo beautify_meta_name(title_case("booking"));?></button>
</h4>
                                </div>
                            </div>
                        </div>     
...
<table class="table table-striped <?php if (safe_get('show_all_fields') == 'yes') {echo 'table-responsive';} ?>" id="list_table_booking">
<?php
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="form-group ic_booking_desk_id col-md-6 d-inline-block">
             <label class="label_booking_desk_id" for="booking_desk_id">Select Table Size</label>
            <select class="form-control booking_desk_id" name="booking_desk_id">
       <?php
...
if (willDelete) {
  ...
  $.post(delete_api_url_booking,{"record_id":record_id_booking});
